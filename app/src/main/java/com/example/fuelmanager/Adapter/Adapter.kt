...
class RefuelAdapter(
                     ...
                     var lstRefuel:List<Refuel>,
                     var dateForRefuelling:EditText,
                     var kiloMeter:EditText,
                     var kilometerbetweenRefuel:EditText,
                     var fuelQuantity:EditText,
                     var priceOfRefuel:EditText
                                                ):BaseAdapter() {
